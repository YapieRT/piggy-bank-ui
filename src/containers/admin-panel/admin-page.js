...
function AdminPage() {
  ...
  const updateBalance = async (event) => {
    event.preventDefault();
    await axios
      .post(`${ip}:3002/admin/updatebalance`, {
          ...
          <div style={{ marginBottom: '10px' }}>
            <div className='wrapper-admin-content'>
              ...
              <div className='admin-header'>
                ...
                <div className='descr'>
                  <p>
                    Welcome to the Piggy Bank Admin Panel. This panel provides access to various administrative tools
                    for managing the internet banking system.
                  </p>
                </div>
              </div>
